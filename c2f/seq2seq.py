...
def decoding_layer(target_letter_to_int, decoding_embedding_size, num_layers, rnn_size,
    ...
    with tf.variable_scope("decode"):
        ...
        training_decoder = tf.contrib.seq2seq.BasicDecoder(cell,
                                                           ...
                                                           encoder_state,
                                                           output_layer)
        # in version 1.2 and upper, become 3 return values, so change to  predicting_decoder_output, _, _
...
def seq2seq_model(input_data, targets, lr, target_sequence_length,
    ...
    _, encoder_state = get_encoder_layer(input_data=input_data,
                                         rnn_size=rnn_size,
    ...
    # target_sequence_length, max_target_sequence_length, encoder_state, decoder_input
    training_decoder_output, predicting_decoder_output= decoding_layer(target_letter_to_int=target_letter_to_int,
...
with train_graph.as_default():
    ...
    # encoder_embedding_size, decoder_embedding_size,
    # rnn_size, num_layers
    training_decoder_output, predicting_decoder_output = seq2seq_model(input_data=input_data,
                                                                       targets=targets,
                                                                       lr=lr,
                                                                       target_sequence_length=target_sequence_length,
                                                                       max_target_sequence_length=max_target_sequence_length,
